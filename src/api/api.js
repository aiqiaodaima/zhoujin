...
const getPermissionListByToken = (params)=>getAction("/sys/permission/getPermissionListByToken",params);
...
export const getDictItemsBatch = (code, params)=>getAction(`/sys/dict/getDictItemsByType/?dictCodes=${code}`,params);
...
//加载审核单类型
const loadProcessTypeList = ()=>getAction("/wkf/auditFormType");

//项目设立获取客户推荐机构信息
const cusRecommendOrgTreeList = (params)=>getAction("/base/cusRecommendOrg/queryTreeList",params);
...
export {
  ...
  loadProcessTypeList,
  getPermissionListByToken,
  cusRecommendOrgTreeList
}
