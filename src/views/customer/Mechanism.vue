      ...
      <a-layout :style="{margin:'0px'}">
          <a-layout-content :style="{margin:'8px'}">
            <a-card size="small" title="基本信息">
              ...
              <a-row :gutter="24">
                <a-col :span="8">
                    <BiFormItemSelect :disabled="optType == 'view'||optType == 'edite'"  :options="dicts.CUS_CATEGORY_ORGAN" label="客户类型" name="cusBasicInfo.partyType" v-model="form.cusBasicInfo.partyType" />
                  </a-col>
                <a-col :span="8">
                  <BiFormItemInput :disabled="optType == 'view'||optType == 'edite'" label="统一社会信用代码"   name="cusBasicInfo.idn" v-model="form.cusBasicInfo.idn" />
                </a-col>
                <a-col :span="8">
                  <a-form-model-item v-if="optType != 'view'" label="有效期" prop="cusBasicInfo.yxDate">
                    <j-date-range :disabled="optType == 'view'" :currentDate="currentDate" @calendarChange="calendarChange"  v-model="form.cusBasicInfo.yxDate" ></j-date-range>
                  </a-form-model-item>
              ...
              <a-row :gutter="24">
                <a-col :span="24">
                  <BiFormItemSelect :disabled="optType == 'view'"  :options="dicts.NAT_CODE" label="所属国别" name="cusBasicInfo.natCode" v-model="form.cusBasicInfo.natCode" />
                </a-col>
              </a-row>
              <a-row :gutter="24">
              ...
              <a-row :gutter="24">
                <a-col :span="24">
                  <a-form-model-item label="通讯地址"  prop="cusBasicInfo.liveAddrProvCode" :key="'Y'">
              ...
              <a-row :gutter="24">
                <a-col :span="24">
                  <BiFormItemInput :disabled="optType == 'view'" label="注册地址"   name="cusBasicInfo.registerAddress" v-model="form.cusBasicInfo.registerAddress"/>
                </a-col>
              </a-row>
              <a-row :gutter="24">
                <a-col :span="24">
                  <BiFormItemTextarea :readonly="optType == 'view'"  label="经营范围" v-model="form.cusBasicInfo.remarks" name="remarks" placeholder="经营范围"/>
                </a-col>
              </a-row>
            </a-card>
            <a-card size="small" title="法定代表人或负责人" style="margin-top:10px">
              <a-row :gutter="24">
                <a-col :span="24">
                  <BiFormItemInput :disabled="optType == 'view'" label="姓名/名称" name="cusBasicInfo.principalName" placeholder="请输入" v-model="form.cusBasicInfo.principalName" />
                </a-col>
              </a-row>
              <a-row :gutter="24">
                <a-col :span="8">
                    <BiFormItemSelect :disabled="optType == 'view'"  :options="dicts.CRM_IDE_TYPE" label="证件类型" name="cusBasicInfo.principalIdnType" v-model="form.cusBasicInfo.principalIdnType" />
                  </a-col>
                <a-col :span="8">
                  <BiFormItemInput :disabled="optType == 'view'" label="证件号码" placeholder="请输入证件号码"  name="cusBasicInfo.principalIdnNo" v-model="form.cusBasicInfo.principalIdnNo" />
                </a-col>
                <a-col :span="8">
                  <a-form-model-item v-if="optType != 'view'" label="有效期" prop="cusBasicInfo.yxDate2">
                    <j-date-range :disabled="optType == 'view'" :currentDate="currentDate2" @calendarChange="calendarChange2" v-model="form.cusBasicInfo.yxDate2" ></j-date-range>
                  </a-form-model-item>

                  <BiFormItemInput v-else disabled label="有效期" :value="form.cusBasicInfo.yxDate2&&(form.cusBasicInfo.yxDate2[0]+'~'+form.cusBasicInfo.yxDate2[1])"/>

                </a-col>
              </a-row>
            </a-card>
            <a-card size="small" title="控股股东或实际控制人" style="margin-top:10px">
              <a-row :gutter="24">
                <a-col :span="24">
                  <BiFormItemInput :disabled="optType == 'view'" label="姓名/名称" name="cusBasicInfo.ctrlerName" placeholder="请输入" v-model="form.cusBasicInfo.ctrlerName" />
                </a-col>
              </a-row>
              <a-row :gutter="24">
                <a-col :span="8">
                    <BiFormItemSelect :disabled="optType == 'view'"  :options="dicts.IDNTYPES" label="证件类型" name="cusBasicInfo.ctrlerIdnType" v-model="form.cusBasicInfo.ctrlerIdnType" />
                  </a-col>
                <a-col :span="8">
                  <BiFormItemInput :disabled="optType == 'view'" label="证件号码" placeholder="请输入证件号码"  name="cusBasicInfo.ctrlerIdnNo" v-model="form.cusBasicInfo.ctrlerIdnNo" />
                </a-col>
                <a-col :span="8">
                  <a-form-model-item v-if="optType != 'view'" label="有效期" prop="cusBasicInfo.yxDate4">
                    <j-date-range :disabled="optType == 'view'" :currentDate="currentDate4" @calendarChange="calendarChange4" v-model="form.cusBasicInfo.yxDate4" ></j-date-range>
                  </a-form-model-item>
                  
                  <BiFormItemInput v-else disabled label="有效期" :value="form.cusBasicInfo.yxDate4&&(form.cusBasicInfo.yxDate4[0]+'~'+form.cusBasicInfo.yxDate4[1])"/>
              ...
              <a-row :gutter="24">
                ...
                <a-col :span="8">
                  <a-form-model-item v-if="optType != 'view'" label="有效期" prop="cusBasicInfo.yxDate3">
                    <j-date-range :disabled="optType == 'view'" :currentDate="currentDate3" @calendarChange="calendarChange3" v-model="form.cusBasicInfo.yxDate3" ></j-date-range>
                  </a-form-model-item>
...
export default {
  ...
  watch: {
    ...
    "form.cusBasicInfo.yxDate2"(val){
      ...
      return
      if(val[0]==''){
        this.currentDate2=moment()
          this.form.cusBasicInfo.yxDate2=[]
      }
      this.form.cusBasicInfo.principalIdnStdDt=val[0]
      this.form.cusBasicInfo.principalIdnEndDt=val[1]
    },
    ...
    "form.cusBasicInfo.yxDate4"(val){
      if(!val)
      return
      if(val[0]==''){
        this.currentDate4=moment()
          this.form.cusBasicInfo.yxDate4=[]
      }
      this.form.cusBasicInfo.ctrlerIdnStdDt=val[0]
      this.form.cusBasicInfo.ctrlerIdnEndDt=val[1]
    },
  },
  created() {
    this.initDictConfig()
  ...
  methods: {
    ...
    calendarChange2(val) {
      this.currentDate2 = val
    },
    calendarChange3(val) {
      this.currentDate3 = val
    },
    calendarChange4(val) {
      this.currentDate4 = val
    },
    toBack(){
      ...
      getAction(this.url.find, { partyCode: this.partyCode })
        .then(res => {
          if (res.success) {
            ...
            if(this.form.cusBasicInfo.principalIdnStdDt&&this.form.cusBasicInfo.principalIdnEndDt){
             // this.form.cusBasicInfo.yxDate2=[this.form.cusBasicInfo.principalIdnStdDt,this.form.cusBasicInfo.principalIdnEndDt]
              this.$set(this.form.cusBasicInfo,'yxDate2',[this.form.cusBasicInfo.principalIdnStdDt,this.form.cusBasicInfo.principalIdnEndDt])
              this.currentDate2=moment(this.form.cusBasicInfo.principalIdnStdDt, "YYYYMMDD")
            }
            ...
            if(this.form.cusBasicInfo.ctrlerIdnStdDt&&this.form.cusBasicInfo.ctrlerIdnEndDt){
              //this.form.cusBasicInfo.yxDate4=[this.form.cusBasicInfo.ctrlerIdnStdDt,this.form.cusBasicInfo.ctrlerIdnEndDt]
               this.$set(this.form.cusBasicInfo,'yxDate4',[this.form.cusBasicInfo.ctrlerIdnStdDt,this.form.cusBasicInfo.ctrlerIdnEndDt])
              this.currentDate4=moment(this.form.cusBasicInfo.ctrlerIdnStdDt, "YYYYMMDD")
            }
    ...
    initDictConfig() {
         this.loading = true
        let promises = [this.getDict('BANK_CODE,CRM_IDE_TYPE,CUS_CATEGORY,CUS_CATEGORY_ORGAN,NAT_CODE,MARITAL_CODE,CONTRACT_SERIE,IDNTYPES,FEE_NAMES_MSG,FEE_CAL_MODE,COM_MODE,FEE_PAY_OBJECT,FREQUENCY2,NATUREDAY_YN,TFIX_TYPE,INT_DAY_BASE,FREQUENCY,TFIX_TYPE,FEE_BASE,ACHIEVEMENT_TYPE,RATE_BASE,GENDER')]
    ...
    doSave(){
      this.$refs.form.validate(valid => {
          ...
          if (valid) {
            ...
            if(this.form.cusBasicInfo.yxDate2&&this.form.cusBasicInfo.yxDate2.length>0){
              var val=this.form.cusBasicInfo.yxDate2
              this.form.cusBasicInfo.principalIdnStdDt=val[0]
              this.form.cusBasicInfo.principalIdnEndDt=val[1]
            }else{
              this.form.cusBasicInfo.principalIdnStdDt=''
              this.form.cusBasicInfo.principalIdnEndDt=''
            }
            ...
            if(this.form.cusBasicInfo.yxDate4&&this.form.cusBasicInfo.yxDate4.length>0){
              var val=this.form.cusBasicInfo.yxDate4
              this.form.cusBasicInfo.ctrlerIdnStdDt=val[0]
              this.form.cusBasicInfo.ctrlerIdnEndDt=val[1]
            }else{
              this.form.cusBasicInfo.ctrlerIdnStdDt=''
              this.form.cusBasicInfo.ctrlerIdnEndDt=''
            }
            const param = this.form
            param.cusBasicInfo.clientType='2'
