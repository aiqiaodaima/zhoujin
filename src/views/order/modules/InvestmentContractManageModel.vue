        ...
        <a-layout>
          <a-layout-content>
            <a-card size="small" title="基本信息" :bordered="false">
              ...
              <a-col :span="8">
                <a-form-model-item label="是否回购" prop="crepurchaseflag">
...
<!-- 这个地区 -->
                ...
                <a-col :span="8">
                  <a-form-model-item label="资金运用方式" prop="cCapuseWay">
                    <j-d-select-tag id="cIndustrydtl" v-model="form.cIndustrydtl" :disabled="isPrjSetup" dict-code="capital_operation_way">
                    </j-d-select-tag>
                  </a-form-model-item>
                </a-col>
              </a-row>
...
<!-- 无字典 -->
              ...
              <a-row :gutter="24">
               <a-col :span="8">
                  <a-form-model-item label="信托交易种类" prop="laffltradetype">
                    <j-d-select-tag id="laffltradetype" v-model="form.laffltradetype" dict-code="transaction_types   ">
                    </j-d-select-tag>
                  </a-form-model-item>
                </a-col>
                <a-col :span="8">
                  <a-form-model-item label="数据确认日期" prop="dqrdate">
                    <j-date
                      id="dqrdate"
                ...
                <a-col :span="8">
                  <a-form-model-item label="备注" prop="cremark">
              ...
              <a-row :gutter="24">
                <a-col :span="8">
                  <a-form-model-item label="评估周期" prop="cevaluateCycle">
                    <j-d-select-tag id="cevaluateCycle" v-model="form.cevaluateCycle" dict-code="evaluation_period">
                    </j-d-select-tag>
                  </a-form-model-item>
                </a-col>
                <a-col :span="8">
                  <a-form-model-item label="评估日期" prop="dEvaluateDate">
                    <j-date
                      id="dEvaluateDate"
                      placeholder="请选择数据确认日期"
                ...
                <a-col :span="8">
                  <a-form-model-item label="成本是否含税" prop="crivalcostTax">
            ...
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-model-item label="是否有保证金" prop="cisBzbalance">
                  <j-d-select-tag id="cisBzbalance" v-model="form.cisBzbalance" dict-code="y_n ">
                  </j-d-select-tag>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="是否投向本公司产品" prop="cisinvestcomfund">
                  <j-d-select-tag id="cisinvestcomfund" v-model="form.cisinvestcomfund" dict-code="y_n ">
                  </j-d-select-tag>
                </a-form-model-item>
              </a-col>
                <a-col :span="8">
                  <a-form-model-item label="被投本公司产品编号" prop="ctocomprojectcode">
            ...
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-model-item label="回购方" prop="crepurchaser">
                  <a-input id="crepurchaser" placeholder="回购方" v-model="form.crepurchaser" ></a-input>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="回购是否有担保" prop="crepurchaseassureflag">
                  <j-d-select-tag id="crepurchaseassureflag" v-model="form.crepurchaseassureflag" dict-code="y_n ">
                  </j-d-select-tag>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="基础资产类型" prop="cassettype">
                  <a-input id="cassettype" placeholder="回购方" v-model="form.cassettype" ></a-input>
                </a-form-model-item>
              </a-col>
            </a-row>
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-model-item label="是否在基金协会备案" prop="cisassociationflag">
                  <j-d-select-tag id="cisassociationflag" v-model="form.cisassociationflag" dict-code="y_n ">
                  </j-d-select-tag>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="投资标的最新评估价值" prop="fevaluationbalance">
                  <a-input id="fevaluationbalance" placeholder="回购方" v-model="form.fevaluationbalance" ></a-input>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="股权出让方" prop="cgqcrfid">
                  <a-input id="cgqcrfid" placeholder="回购方" v-model="form.cgqcrfid" ></a-input>
                </a-form-model-item>
              </a-col>
            </a-row>
            ...
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-model-item label="代偿方" prop="cIndemnifierid">
                  <a-input id="cIndemnifierid" placeholder="回购方" v-model="form.cIndemnifierid" ></a-input>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="是否固定资产投资" prop="cisfixedassets">
                  <j-d-select-tag id="cisfixedassets" v-model="form.cisfixedassets" dict-code="y_n ">
                  </j-d-select-tag>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item label="是否发生借新还旧" prop="crefinancingflag">
            ...
            <a-row :gutter="24">
              <a-col :span="8">
                <a-form-model-item label="数据日期" prop="ddatadate">
                  <j-date
                    id="ddatadate"
                    placeholder="请选择数据日期"
...
<!-- 字典无   -->
              <a-col :span="8">
                <a-form-model-item label="数据来源" prop="csourceno">
...
<!-- 字典无 -->
              <a-col :span="8">
                <a-form-model-item label="行标识" prop="crowflag">
...
<!-- 字典无 -->
              <a-col :span="8">
                <a-form-model-item label="采集标志" prop="lcollflag">
...
<!-- 字典无 -->
             <a-col :span="8">
                <a-form-model-item label="维护标志" prop="lmodiflag">
...
<!-- 字典无 -->
              <a-col :span="8">
                <a-form-model-item label="更新人" prop="cmodiman">
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        areas:[], // 地区
        rules:r,
        tempIssuerCode: ''  //存储临时的issuerCode，用于判断
    ...
    methods: {
      ...
      //请求投资项目编号--通过orders/common/queryPro【查询资产名称】接口返回prjCode 如果为空就页面填写  【可以叫理财产品】
      // 看下这个接口是请求方式是get 还是post 确定请求方法--  post  
      //在return中写数组接收返回的一堆数据---我可以在form中接收吗？
        // 资产名称Asset name

        // 被投标的编号 orders/common/queryPro请求 接口返回的proCode，选中后 带出 投资项目编号 和产品代码
        // 投资项目编号 如果prjCode 如果为空就页面填写，有数据则带出数据，

        // 产品代码 profitID 如果为空就页面填写--项目对应的产品代码分期募集时 填写主产品代码

        // admOrgnaiztionInfo/list 接口返回的 orgCode ，与C_ASSETNO 有联动，当C_ASSETNO选择后，
        // 根据返回的issuerCode与orgCode 相等自动选择   可按照 交易管理/投资交易单/返本  中联动处理
      ...
      handleChange(value){
         ...
         *   这里的item 就是选中的项目
         *   filter es6 数组方法 
         *   filter() 方法创建一个新的数组，新数组中的元素是通过检查指定数组中符合条件的所有元素,并且返回一个数组。
         *   在这里就是返回选中的对象
        ...
        if(item.proCode){
          ...
          // 这里投资项目编号
          this.form.cinvestcode = item.bankProCode

          // 产品代码
          this.form.cFundCode = item.pfcatCode
          
          // 临时存储的tempIssuerCode
          this.tempIssuerCode = item.issuerCode
      ...
      async getCrivalId(){
        await getAction('admOrgnaiztionInfo/list').then(res=>{
          if(res.success){
            // try 防止页面卡死，这里主要是因为res.result后台返回{} || undefined
            try {
                ...
                // findItem === undefined 代表没有找到符合条件的这个根据返回的issuerCode与orgCode 相等自动选择   可按照 交易管理/投资交易单/返本  中联动处理
      ...
      //   // let that = this
      //   // 请求项目编号---这个接口有点问题
      //   await postAction('/orders/common/queryPro').then(res=>{
      //     if(res.success){
      //       // 2.请求数据给这个
      //       // this.cprojcode =res.result.records
      //       // console.log(this.cprojcode)
