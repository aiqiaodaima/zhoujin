  ...
  export default {
    ...
    methods: {
      add () {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick({isCancle:"Y"},'isCancle'));
        });
      },
      edit (record) {
        let that = this;
        ...
        this.$nextTick(() => {
          ...
          that.form.setFieldsValue(pick(this.model,'processName','sort','processCode','isCancle','processDesc','processVariables'));//时间格式化
        });
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            let httpUrl = this.optType==='create'?this.url.create:this.url.edit;
            let method = 'post';
