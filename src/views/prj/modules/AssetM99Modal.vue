  ...
  <j-modal
    ...
    <a-spin :spinning="confirmLoading" style="margin: 5px;">
      <a-form :form="form" ref="form" formLayout="horizontal">
        ...
        <a-card size="small" title="其他管理类资产信息" :bordered="true">
          <a-row :gutter="24">
            ...
            <BiCol><BiFormItemInput :disabled="disabled" label="代码/证书编号" :decorator="customizeEnv=='sdic'?['cusAssetOth.certCode']:['cusAssetOth.certCode', rules.globalReq]"/></BiCol>
            ...
            postAction(that.url.save, formData).then((res)=>{
              if(res.success){
                ...
                if(filesNeed2Upload.length>0){
                  ...
                  formData.append("module","ASSET_OTH");
